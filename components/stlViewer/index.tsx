		...
		const handleClick = (event) => {
			if (!draggingControl) {
				...
				const scrollRotate = (e) => {
					...
					// intersects[0].object.parent.rotateX(0.1*x) //EDIT Twinstar
					intersects[0].object.parent.rotateY(0.5*y)
					// intersects[0].object.parent.rotateZ(z) //EDIT Twinstar
